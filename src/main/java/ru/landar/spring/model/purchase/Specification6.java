...
@ObjectTitle(single="Спецификация уведомления об утвержденных показателях бюджетной сметы", multi="Спецификации уведомлений об утвержденных показателях бюджетной сметы")
